...
Rectangle{
    ...
    Image {
        id: background
        source: "PhotoViewerCore/images/background.png"
        anchors.fill: parent
        anchors.margins: 0
        opacity: 1;
        asynchronous: true
...
Rectangle {
    ...
    Column {
        ...
        //Still PlexyDesk cannot handle single QML app quit
//        Button {
...
//        }
    ...
    Button { id: backButton; label: qsTr("Back"); rotation: 3; x: parent.width - backButton.width - 6; y: -backButton.height - 8; opacity: 0 }
