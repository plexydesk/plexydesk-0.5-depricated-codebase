...
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\phonon4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\Qt3Support4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtCLucene4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtCore4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtDeclarative4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtDesigner4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtDesignerComponents4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtGui4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtHelp4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtMultimedia4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtNetwork4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtOpenGL4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtScript4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtScriptTools4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtSql4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtSvg4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtTest4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtWebKit4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtXml4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtXmlPatterns4.dll" "%FINAL_PATH%\lib\qt4\lib\"
...
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\phonond4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\Qt3Supportd4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtCLucened4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtCored4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtDeclaratived4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtDesignerd4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtDesignerComponentsd4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtGuid4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtHelpd4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtMultimediad4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtNetworkd4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtOpenGLd4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtScriptd4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtScriptToolsd4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtSqld4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtSvgd4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtTestd4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtWebKitd4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtXmld4.dll" "%FINAL_PATH%\lib\qt4\lib\"
xcopy %COPY_DEBUG_LEVEL% /R /Y "%QT_LIB_DIR_COPY%\QtXmlPatternsd4.dll" "%FINAL_PATH%\lib\qt4\lib\"
