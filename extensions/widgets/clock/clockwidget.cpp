...
void
ClockWidget::paintExtFace(QPainter *p, const QStyleOptionGraphicsItem * e , QWidget *)
{
...
void
ClockWidget::paintExtDockFace(QPainter *p, const QStyleOptionGraphicsItem * e , QWidget *)
{
