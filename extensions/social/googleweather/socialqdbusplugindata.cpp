...
bool SocialQDBusPluginData::getAuthentication(QString pluginName, QString uName, QString pWord)
{
    return true;
}
QVariantMap SocialQDBusPluginData::getAuthenticatedDataForMethod(QString pluginName, QString methodName, QString uName, QString pWord)
{
    QVariantMap args;
    args["uname"] = QVariant(uName);
    args["pword"] = QVariant(pWord);
    return this->getData(pluginName, methodName, args);
}
