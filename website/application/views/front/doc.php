...
<div id="wrap">
	<div id="header">
		...
		<ul class="menu">
			...
			<li><a href="doc.php">PlexyDesk</a></li>
			<li><a href="">Download</a></li>
			<li><a href="">Hacking</a></li>
			<li><a href="">Ideas</a></li>
			<li><a href="team.php">Team</a></li>
			<li><a href="blog_home.php">Blog</a></li>
	...
	<div id="content">
		<div id="main">
			<div class="main-block">
				...
				<ul class="list">
					<li>normal item</li>
					<li class="delete">normal item with differen bullet image</li>
					<li><a href="">linked item</a></li>
					<li class="bold">bold item</li>
				</ul>
				<p>
					PlexyDesk is an exciting project with great goals which is done by a wonderful and an experienced team who are responsive and talented in multitude of ways...
					PlexyDesk aims to tackle some modern day desktop problems and also many problems that the users are likely to face in the future. PlexyDesk ideas are geared towards solving those challenging problems. PlexyDesk ideas are geared towards solving those challenging problems
				</p>
				<h2>Small headding</h2>
				<p>
						PlexyDesk aims to tackle some modern day desktop problems and also many problems that the users are likely to face in the future. PlexyDesk ideas are geared towards solving those challenging problems. PlexyDesk ideas are geared towards solving those challenging problems
				</p>
				<p class="quote green">
		...
		<div id="side-bar">
			<div class="side-block">
				<ul class="side-nav">
					...
					<li><a href="">Developemt</a></li>
					<li><a href="">Bug Traking</a></li>
					<li><a href="">Community feed back</a></li>
				<ul>
			</div>
			<div class="side-block">
